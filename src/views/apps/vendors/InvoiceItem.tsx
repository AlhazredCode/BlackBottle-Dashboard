...
// project import
import InvoiceField from 'sections/apps/invoice/InvoiceField';
...
export default function InvoiceItem({ id, name, description, qty, price, onDeleteItem, onEditItem, index, Blur, errors, touched }: any) {
  ...
  const textFieldItem = [
    ...
    { placeholder: '', label: 'contact', type: 'number', name: `invoice_detail.${index}.price`, id: id + '_price', value: price }
  ];
