          ...
          <Grid container spacing={2} sx={{ pr: 10, [theme.breakpoints.down('md')]: { pr: 0, textAlign: 'center' } }}>
            <Grid item xs={12}>
              ...
              >
                <Typography
                  ...
                  color="white"
                  sx={{
                    fontSize: { xs: '2.825rem', sm: '3rem', md: '3.5rem' },
                    fontWeight: 700,
                    lineHeight: { xs: 1.3, sm: 1.3, md: 1.3 }
                  }}
                >
                  <span>Welcome to the future of </span>
            ...
            <Grid item xs={12}>
              ...
              >
                ...
                >
                  Black Bottle Sofware is all-in-one tool for manage your Bar, Inventories, Staff, Guests and more.
                </Typography>
              </motion.div>
            </Grid>
