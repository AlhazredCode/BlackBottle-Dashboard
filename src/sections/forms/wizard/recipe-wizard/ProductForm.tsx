        ...
        <Grid container spacing={3} xs={12} >
          <Grid item xs={12} sm={6} >
            <MainCard sx={{ margin: 3 }} >
              ...
              <CardMedia
                ...
                component="img"
                image={`/assets/images/e-commerce/recipeimg.png`}
                title="Scroll Zoom"
          ...
          <Grid item xs={12} sm={6}>
            <Stack spacing={1}>
              ...
              <TextField required id="lastNameBasic" name="lastName" placeholder="Product Type" fullWidth autoComplete="family-name" />
